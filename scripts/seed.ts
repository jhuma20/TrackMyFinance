import { drizzle } from "drizzle-orm/neon-http"; // Corrected import statement
...
const SEED_USER_ID = "user_2wwxGOIIsr8fHzGUiFcRb5uyIq9";
...
const SEED_TRANSACTIONS: typeof transactions.$inferInsert[] = []; // Corrected type inference
...
const generateTransactionsForDay = (day: Date) => {
    ...
    for (let i = 0; i < numTransactions; i++) {
        ...
        const formattedAmount = converAmountToMiliunits(isExpense ? -amount : amount);
...
const generateTransactions = () => {
    ...
    days.forEach(day => generateTransactionsForDay(day)); // Corrected function call
};
